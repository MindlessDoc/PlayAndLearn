    ...
    private static void createButtons(Square button) {
        ...
        for (int i = 0; i < formattedWords.size(); i++) {
            ...
            switch (formattedWords.get(i).sizeMode) {
                case 1:
                    font = new Font(fontName, Font.PLAIN, (int) ((double) 1 / 6 * height));
                    break;
                case 2:
                    font = new Font(fontName, Font.PLAIN, (int) ((double) 2 / 6 * height));
                    break;
                case 3:
                    font = new Font(fontName, Font.PLAIN, (int) ((double) 3 / 6 * height));
                    break;
                case 4:
                    font = new Font(fontName, Font.PLAIN, (int) ((double) 4 / 6 * height));
                    break;
                case 5:
                    font = new Font(fontName, Font.PLAIN, (int) ((double) 5 / 6 * height));
                    break;
                case 6:
